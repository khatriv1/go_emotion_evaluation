# goemotions_evaluation/evaluation/evaluate_cot.py
...
from prompting.cot import get_cot_prediction_all_emotions
...
def evaluate_cot(data_path: str, api_key: str, output_dir: str = "results/cot", limit: int = None):
    """Evaluate Chain of Thought prompting technique on GoEmotions dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            model_emotions = get_cot_prediction_all_emotions(
                text=row['text'],
    ...
    # Print results
    print_detailed_results(metrics, emotions, 'Chain of Thought')
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Chain of Thought evaluation on GoEmotions dataset...")
