# goemotions_evaluation/evaluation/evaluate_rephrase_respond.py
...
from prompting.rephrase_and_respond import get_rephrase_respond_prediction_all_emotions
...
def evaluate_rephrase_respond(data_path: str, api_key: str, output_dir: str = "results/rephrase_respond", limit: int = None):
    """Evaluate Rephrase and Respond prompting technique on GoEmotions dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            model_emotions = get_rephrase_respond_prediction_all_emotions(
                text=row['text'],
    ...
    # Print results
    print_detailed_results(metrics, emotions, 'Rephrase and Respond')
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Rephrase and Respond evaluation on GoEmotions dataset...")
