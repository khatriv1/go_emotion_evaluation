# goemotions_evaluation/evaluation/evaluate_auto_cot.py
...
def evaluate_auto_cot(data_path: str, api_key: str, output_dir: str = "results/auto_cot", limit: int = None):
    """Evaluate Auto-CoT prompting technique on GoEmotions dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            model_emotions = get_auto_cot_prediction_all_emotions(
                text=row['text'],
    ...
    try:
        ...
        print(f"Performance plot saved to {output_dir}/auto_cot_performance.png")
    except Exception as e:
        print(f"Could not create plot: {e}")
    
    # Print results
    print_detailed_results(metrics, emotions, 'Auto-CoT')
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Auto-CoT evaluation on GoEmotions dataset...")
