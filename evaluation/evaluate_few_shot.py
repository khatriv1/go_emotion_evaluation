# goemotions_evaluation/evaluation/evaluate_few_shot.py
...
def evaluate_few_shot(data_path: str, api_key: str, output_dir: str = "results/few_shot", limit: int = None):
    """Evaluate Few-shot prompting technique on GoEmotions dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            model_emotions = get_few_shot_prediction_all_emotions(
                text=row['text'],
