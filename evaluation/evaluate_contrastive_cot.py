# goemotions_evaluation/evaluation/evaluate_contrastive_cot.py
...
from prompting.contrastive_cot import get_contrastive_cot_prediction_all_emotions
...
def evaluate_contrastive_cot(data_path: str, api_key: str, output_dir: str = "results/contrastive_cot", limit: int = None):
    """Evaluate Contrastive CoT prompting technique on GoEmotions dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            model_emotions = get_contrastive_cot_prediction_all_emotions(
                text=row['text'],
    ...
    # Print results
    print_detailed_results(metrics, emotions, 'Contrastive CoT')
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Contrastive CoT evaluation on GoEmotions dataset...")
