# goemotions_evaluation/evaluation/evaluate_take_step_back.py
...
from prompting.take_a_step_back import get_take_step_back_prediction_all_emotions
...
def evaluate_take_step_back(data_path: str, api_key: str, output_dir: str = "results/take_step_back", limit: int = None):
    """Evaluate Take a Step Back prompting technique on GoEmotions dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            model_emotions = get_take_step_back_prediction_all_emotions(
                text=row['text'],
    ...
    # Print results
    print_detailed_results(metrics, emotions, 'Take a Step Back')
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Take a Step Back evaluation on GoEmotions dataset...")
