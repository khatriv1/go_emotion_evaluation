...
class GoEmotionsRubric:
    ...
    def __init__(self):
        ...
        # }
        self.emotion_definitions = {
            "admiration": "Appreciating excellence and showing respect",
            "amusement": "Finding things funny and entertaining",
            "anger": "Strong displeasure and hostility",
            "annoyance": "Mild irritation and frustration",
            "approval": "Favorable opinion and endorsement",
            "caring": "Showing kindness and concern",
            "confusion": "Lack of understanding and uncertainty",
            "curiosity": "Intense desire for knowledge and exploration",
            "desire": "Strong wanting and yearning",
            "disappointment": "Sadness from unfulfilled hopes",
            "disapproval": "Unfavorable opinion and dissent",
            "disgust": "Strong aversion and repulsion",
            "embarrassment": "Feeling self-conscious and awkward",
            "excitement": "Enthusiasm and eager anticipation",
            "fear": "Being afraid and anxious",
            "gratitude": "Feeling thankful and appreciative",
            "grief": "Intense sorrow, especially from loss",
            "joy": "Feeling pleasure and happiness",
            "love": "Strong affection and positive regard",
            "nervousness": "Feeling anxious and worried",
            "optimism": "Hopeful and confident outlook",
            "pride": "Satisfaction and pride in achievements",
            "realization": "Becoming aware of something",
            "relief": "Feeling reassured and relaxed",
            "remorse": "Regret and guilt",
            "sadness": "Emotional pain and sorrow",
            "surprise": "Feeling astonished and caught off guard",
            "neutral": "Showing no strong emotion, staying balanced"
    }
